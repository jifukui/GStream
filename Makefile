...
CONFIG_CLEAN_FILES = data/bash-completion/helpers/gst stamp.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	...
	$(top_srcdir)/data/bash-completion/helpers/gst.in ABOUT-NLS \
...
ACLOCAL = ${SHELL} /home/jifukui/jifukuistudy/sourcecode/GStream/missing aclocal-1.16
...
AR = ar
AS = as
AUTOCONF = ${SHELL} /home/jifukui/jifukuistudy/sourcecode/GStream/missing autoconf
AUTOHEADER = ${SHELL} /home/jifukui/jifukuistudy/sourcecode/GStream/missing autoheader
AUTOMAKE = ${SHELL} /home/jifukui/jifukuistudy/sourcecode/GStream/missing automake-1.16
AWK = gawk
BASH_COMPLETION_CFLAGS = 
BASH_COMPLETION_DIR = ${datarootdir}/bash-completion/completions
BASH_COMPLETION_LIBS = 
BASH_HELPERS_DIR = ${datarootdir}/bash-completion/helpers
...
GIO_CFLAGS = -pthread -I/usr/local/include/glib-2.0 -I/usr/local/lib/glib-2.0/include 
GIO_LDFLAGS = 
GIO_LIBS = -L/usr/local/lib -lgio-2.0 -lgobject-2.0 -lglib-2.0 
...
GLIB_LIBS = -L/usr/local/lib -lgobject-2.0 -lgmodule-2.0 -pthread -lglib-2.0 
...
GST_AGE = 1600
GST_ALL_CFLAGS = -I$(top_srcdir)/libs -I$(top_srcdir) -I$(top_builddir)/libs -I$(top_builddir) -pthread -I/usr/local/include/glib-2.0 -I/usr/local/lib/glib-2.0/include  $(GLIB_EXTRA_CFLAGS) -fno-strict-aliasing $(GST_OPTION_CFLAGS) $(ERROR_CFLAGS) $(VISIBILITY_CFLAGS)
GST_ALL_CXXFLAGS = -I$(top_srcdir)/libs -I$(top_srcdir) -I$(top_builddir)/libs -I$(top_builddir) -pthread -I/usr/local/include/glib-2.0 -I/usr/local/lib/glib-2.0/include  $(GLIB_EXTRA_CFLAGS) -fno-strict-aliasing $(GST_OPTION_CXXFLAGS) $(ERROR_CXXFLAGS)
GST_ALL_LDFLAGS = -no-undefined -Wl,-Bsymbolic-functions
GST_ALL_LIBS = -L/usr/local/lib -lgobject-2.0 -lgmodule-2.0 -pthread -lglib-2.0   $(GCOV_LIBS)
GST_API_VERSION = 1.0
GST_COMPLETION_HELPER_INSTALLED = /usr/local/libexec/gstreamer-1.0/gst-completion-helper
GST_CURRENT = 1600
...
GST_DISABLE_GST_TRACER_HOOKS_DEFINE = /* #undef GST_DISABLE_GST_TRACER_HOOKS */
...
GST_LIB_LDFLAGS = 
GST_LICENSE = LGPL
GST_LT_LDFLAGS =  -version-info 1600:0:1600
...
GST_PKG_CONFIG_PATH = $(top_builddir)/pkgconfig://:/usr/local/lib/pkgconfig:/usr/local/lib/pkgconfig
...
LT_SYS_LIBRARY_PATH = 
MAINT = 
MAKEINFO = ${SHELL} /home/jifukui/jifukuistudy/sourcecode/GStream/missing makeinfo
MANIFEST_TOOL = :
...
PACKAGE_STRING = GStreamer 1.16.0
...
PKG_CONFIG = /opt/eldk-5.5.2/powerpc/sysroots/i686-eldk-linux/usr/bin/pkg-config
...
VALGRIND_LIBS = -L/usr/local/lib/valgrind -lcoregrind-x86-linux -lvex-x86-linux -lgcc 
...
abs_builddir = /home/jifukui/jifukuistudy/sourcecode/GStream
abs_srcdir = /home/jifukui/jifukuistudy/sourcecode/GStream
abs_top_builddir = /home/jifukui/jifukuistudy/sourcecode/GStream
abs_top_srcdir = /home/jifukui/jifukuistudy/sourcecode/GStream
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/jifukui/jifukuistudy/sourcecode/GStream/install-sh
...
data/bash-completion/helpers/gst: $(top_builddir)/config.status $(top_srcdir)/data/bash-completion/helpers/gst.in
